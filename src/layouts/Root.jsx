...
const Root = () => {
    ...
    const mainRoot = window.document.documentElement;
    ...
    useEffect(() => {
        ...
        mainRoot.className = "";
        mainRoot.classList.add(theme);

    }, [theme, mainRoot.classList, mainRoot])
    ...
    return (
        <div>
            ...
            <main className="max-w-7xl min-h-screen xl:p-0 lg:p-6 p-4 mx-auto">
                <Outlet></Outlet>
                <ToastContainer />
                <div className="fixed bottom-6 right-6 btn btn-primary rounded-full text-white h-[50px] w-[50px] flex justify-center items-center">
